 ...
 * <ul>
 * <li>When you want to call something on one side and return a result {@link #safeCallWhenOn(EnvType, Supplier)}</li>
 ...
 * <li>When you want to run something on one side {@link #safeRunWhenOn(EnvType, Supplier)}</li>
 * </ul>
 */
public final class DistExecutor {
	...
	/**
	 * Call the SafeCallable when on the correct {@link EnvType}.
	 *
	...
	/**
	 * Runs the supplied Runnable on the speicified side. Same warnings apply as {@link #callWhenOn(EnvType, Supplier)}.
	 * <p>
	 * This method can cause unexpected ClassNotFound exceptions.
	 *
	...
	/**
	 * Runs the supplied Runnable on the speicified side. Same warnings apply as {@link #unsafeCallWhenOn(EnvType, Supplier)}.
	 * <p>
